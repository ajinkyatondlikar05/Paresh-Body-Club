        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div className="leading-tight">
              <div className="font-display font-black text-white text-base sm:text-lg tracking-tight leading-none">
                PARESH
              </div>
              <div className="font-display font-black text-red-500 text-base sm:text-lg tracking-tight leading-none">
                BODY CLUB
              </div>
              <div className="text-[9px] uppercase tracking-[0.18em] text-stone-400 font-bold leading-tight mt-0.5">
                MURBAD BRANCH
              </div>
            </div>
          </div>
