  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 top-0 bottom-0 w-[50vw] xl:w-[46vw] hidden lg:block z-10 pointer-events-none select-none overflow-hidden">
        {/* Subtle red background glows behind the photo to separate founder from backdrop */}
        ...
        {/* Gradient masks to seamlessly blend the edges into the solid background */}
        {/* Left edge fade - narrowed to prevent shadowing the face */}
        <div className="absolute left-0 inset-y-0 w-[28%] bg-gradient-to-r from-black via-black/50 to-transparent z-20" />
        
        {/* Bottom edge fade (solid black block + gradient above it to fully block out the photographer watermark) */}
        ...
        {/* Top edge fade - shallow to avoid shadow on the head/eyes */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
        ...
        {/* TOP PANEL: 2 columns on desktop (left text, right column empty on desktop for background image) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mb-12">
          ...
          <div className="lg:col-span-8 space-y-6 text-left relative z-20">
            ...
            {/* Philosophy Room Glassmorphism Quote Card - Wider & Dark Red tinted */}
          ...
          <div className="lg:col-span-4 block lg:hidden relative h-[450px] sm:h-[550px] w-full select-none overflow-hidden rounded-xl mt-4">
            ...
            <img
              ...
              className="w-full h-full object-cover object-center filter brightness-[1.16] contrast-[1.18] saturate-[1.12] hue-rotate-[2deg] drop-shadow-[0_0_35px_rgba(239,68,68,0.12)] relative z-10"
            />
            {/* Volumetric Warm Spotlight & Rim Lighting (Face, Shoulder, Bicep) for mobile */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_42%_32%,rgba(254,215,170,0.12)_0%,rgba(239,68,68,0.06)_30%,transparent_60%)] z-15 pointer-events-none mix-blend-screen" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_65%_45%,rgba(254,215,170,0.08)_0%,rgba(239,68,68,0.04)_35%,transparent_70%)] z-15 pointer-events-none mix-blend-screen" />
            
            {/* Edge blending for mobile container */}
            <div className="absolute left-0 inset-y-0 w-[20%] bg-gradient-to-r from-black via-black/60 to-transparent z-20 pointer-events-none" />
            
            {/* Solid black block + gradient above it to block out the photographer watermark */}
            <div className="absolute bottom-0 inset-x-0 h-[80px] bg-black z-20 pointer-events-none" />
            <div className="absolute bottom-[80px] inset-x-0 h-[100px] bg-gradient-to-t from-black to-transparent z-20 pointer-events-none" />
            
            <div className="absolute top-0 inset-x-0 h-[50px] bg-gradient-to-b from-black to-transparent z-20 pointer-events-none" />
            <div className="absolute right-0 inset-y-0 w-[15%] bg-gradient-to-l from-black to-transparent z-20 pointer-events-none" />
          </div>
