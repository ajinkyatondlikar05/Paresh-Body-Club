      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col gap-8 mb-16 lg:items-center">
          ...
          <motion.div
            ...
            whileHover={{ y: -4, scale: 1.02, borderColor: "rgba(239,68,68,0.3)", boxShadow: "0 15px 40px rgba(239,68,68,0.15)", transition: { duration: 0.2 } }}
            className="bg-stone-900/60 border border-white/5 py-5 px-8 sm:py-6 sm:px-12 rounded-2xl flex flex-col items-center justify-center backdrop-blur-sm shadow-[0_10px_30px_rgba(0,0,0,0.6)] self-start lg:self-center w-fit transition-colors duration-200 cursor-default"
          >
              ...
              {Array.from({ length: 5 }).map((_, i) => (
                <motion.div
                  ...
                  variants={{
                    ...
                    visible: { opacity: 1, scale: 1, rotate: 0, transition: { type: "spring", stiffness: 400 } }
                  }}
                >
        ...
        >
          {REVIEWS.map((rev) => (
            <motion.div
              ...
              whileHover={{ y: -6, borderColor: "rgba(239, 68, 68, 0.4)", boxShadow: "0 15px 35px rgba(239,68,68,0.1)", transition: { duration: 0.2 } }}
              whileTap={{ scale: 0.98 }}
              className="relative p-6 sm:p-8 rounded-2xl bg-stone-900/45 hover:bg-stone-900/90 border border-white/5 transition-colors duration-200 group backdrop-blur shadow-md flex flex-col justify-between"
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  >
                    <Quote size={20} className="text-stone-800 group-hover:text-red-950 transition-colors duration-200" />
                  </motion.div>
                </div>
              ...
              <div className="border-t border-white/5 pt-4 flex items-center justify-between mt-auto">
                <h4 className="font-display font-bold text-xs sm:text-sm text-white group-hover:text-red-500 transition-colors duration-150 uppercase">
                  {rev.author}
                </h4>
